...
page_title: "truewatch_membergroup Resource - truewatch"
subcategory: ""
description: |-
  Member Group
  ...
  resource "truewatchmembergroup" "demo" {
    name          = "oac-demo2"
    accountuuids = data.truewatch_members.demo.members[*].uuid
  }
  output "member" {
...
# truewatch_membergroup (Resource)
